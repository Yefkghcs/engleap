    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-0 left-1/4 w-[450px] h-[450px] bg-secondary/20 rounded-full blur-3xl animate-pulse"
            style={{
              animationDelay: "2s",
            }}
          />
          ...
          <div
            className="absolute -bottom-20 right-0 w-80 h-80 bg-accent/20 rounded-full blur-3xl animate-pulse"
            style={{
              animationDelay: "1s",
            }}
          />
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <p className="text-primary font-medium">
              <span className="bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_auto] animate-[shimmer_3s_ease-in-out_infinite] bg-clip-text text-transparent">
                AI-Powered English Learning, Made Simple and Effective
              </span>
            </p>
              ...
              <div className="space-y-6">
                ...
                <Button asChild size="lg" className="w-full">
                  <Link to="/vocabulary" className="flex items-center justify-center gap-2">
                    马上开始 <ArrowRight className="w-5 h-5" />
                  </Link>
                </Button>
              </div>
            </Card>
